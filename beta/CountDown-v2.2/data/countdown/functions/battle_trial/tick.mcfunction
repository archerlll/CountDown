...
execute as @e[tag=BattleTrialEjection] at @s run scoreboard players add @a[distance=..48] Integration 120
...
execute as @e[tag=BattleTrial] if score @s TimerMin30 matches 36000.. run tellraw @a[distance=48] "挑战超时"
