...
#史莱姆上骑着射手
execute as @e[tag=BattleTrial] at @s run data modify block ~ ~ ~ {}.spawn_potentials append value {custom_spawn_rules: {block_light_limit: {min: 0}, sky_light_limit: {min: 0}}, weight: 1, data: {entity: {id: "minecraft:piglin", Size: 3,Passengers: [{id:"minecraft:skeleton", HandItems:[{id:"minecraft:bow",Count:1b}], ArmorItems:[{},{},{},{id:"minecraft:leather_helmet",Count:1b}]}]}}}
